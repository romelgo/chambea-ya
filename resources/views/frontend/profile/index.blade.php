            ...
            <div class="col-md-4">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <p>Número de teléfono: <strong class="badge bg-secondary badge-primary">{{ Auth::user()->profile->phone }} </strong> </p>
                        <p>Direccion: <strong class="badge bg-secondary badge-primary"> {{ Auth::user()->profile->address }}</strong> </p>
