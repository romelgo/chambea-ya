                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <?php if(!empty(Auth::user()->profile->resume)): ?>
                            <p>Download CV: <strong class="badge bg-info badge-primary"><a  class="text-white"target="_blank" href="<?php echo e(url('storage/'.Auth::user()->profile->resume)); ?>"> CV</a> </strong></p>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\despligue\portal-v1\resources\views/frontend/profile/index.blade.php ENDPATH**/ ?>