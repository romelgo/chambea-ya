            ...
            <div class="col-10">
              <nav class="site-navigation text-right" role="navigation">
                <div class="container pr-0">
                  ...
                  <li class="<?php echo e(request()->routeIs('home') ? 'active' : ''); ?>"><a href="/">Inicio</a></li>
                  <li class="<?php echo e(request()->routeIs('alljobs') ? 'active' : ''); ?>"><a href="<?php echo e(route('alljobs')); ?>">Empleos</a></li>
                    <li class="<?php echo e(request()->routeIs('company') ? 'active' : ''); ?>"><a href="<?php echo e(route('company')); ?>">Empresas</a></li>
                    ...
                    <?php if(!Auth::check()): ?>
                      <li class="has-children">
                            ...
                            <ul class="dropdown arrow-top">
                              ...
                              <li><a  href="<?php echo e(route('employer.register')); ?>">
                   ...
                   <!--  <li class="<?php echo e(request()->routeIs('/register') ? 'active' : ''); ?>"><a href="/register">USUARIO</a></li>
                    <li class="<?php echo e(request()->routeIs('employer.register') ? 'active' : ''); ?>"><a href="<?php echo e(route('employer.register')); ?>">Empresa</a></li> -->
                    <?php else: ?>
                        ...
                        <li class="has-children">
                          ...
                          <ul class="dropdown arrow-top">
                            ...
                            <li><a  href="<?php echo e(route('jobs.applications')); ?>">
                                <?php echo e(__('Mis postulaciones')); ?>

                            </a></li>
                            <li><a  href="<?php echo e(route('home')); ?>">
                                <?php echo e(__('Trabajos guardados')); ?>
                    ...
                    <?php else: ?>
                      <li>
                        <a class="bg-info text-white py-3 px-3 rounded" href="<?php echo e(route('logout')); ?>"
                          onclick="event.preventDefault();
                                        document.getElementById('logout-form').submit();">
                          <span class="icon-sign-out mr-3"></span><?php echo e(__('CERRAR SESION')); ?>
...
unset($__errorArgs, $__bag); ?>
  ...
  <?php /**PATH D:\despligue\portal-v1\resources\views////frontend/partials/nav.blade.php ENDPATH**/ ?>